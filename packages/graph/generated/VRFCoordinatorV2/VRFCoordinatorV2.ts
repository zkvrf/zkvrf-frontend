...
export class VRFCoordinatorV2 extends ethereum.SmartContract {
  ...
  try_getFeeConfig(): ethereum.CallResult<VRFCoordinatorV2__getFeeConfigResult> {
    let result = super.tryCall(
      'getFeeConfig',
      'getFeeConfig():(uint32,uint32,uint32,uint32,uint32,uint24,uint24,uint24,uint24)',
      []
  ...
  try_getRequestConfig(): ethereum.CallResult<VRFCoordinatorV2__getRequestConfigResult> {
    let result = super.tryCall(
      'getRequestConfig',
      'getRequestConfig():(uint16,uint32,bytes32[])',
      []
